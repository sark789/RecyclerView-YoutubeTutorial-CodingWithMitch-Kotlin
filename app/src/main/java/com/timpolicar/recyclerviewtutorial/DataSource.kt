...
class DataSource{
    ...
    but needs access to the internals of a class, you can write it as a member of a
    companion object declaration inside that class. By declaring a companion object inside our class,
    ...
    //In a real app you dont hardcode data like this, u get it from the internet or something like that
    companion object {
